...
namespace EasyMartTests.TagHelpers
{
    public class EmailTagHelperTests
    {
        ...
        {
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "test@easymart.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:test@easymart.com", tagHelperOutput.Attributes[0].Value);
        }
